...
cert:
	mkcert -install
	mkcert -cert-file ./docker/traefik/php-russia-2024-laravel.local.crt -key-file ./docker/traefik/php-russia-2024-laravel.local.key "*.php-russia-2024-laravel.local"
.PHONY: cert

hosts:
	sudo sh -c "echo '127.0.0.1 api.php-russia-2024-laravel.local' >> /etc/hosts"
	sudo sh -c "echo '127.0.0.1 traefik.php-russia-2024-laravel.local' >> /etc/hosts"
	sudo sh -c "echo '127.0.0.1 minio.php-russia-2024-laravel.local' >> /etc/hosts"
	sudo sh -c "echo '127.0.0.1 s3.php-russia-2024-laravel.local' >> /etc/hosts"
.PHONY: hosts
